<?php require 'DbHeader.php';?>
    ...
    <form action="Auth.php" method="post">
        <div class="container">
            <div class="row">
                <div class="center col-sm-12" style="margin-top: 9%">
                    <h1 style=""> Вход(или что то вроде того) </h1>
                </div>
            </div>
            <div class="row" style="">
        ...
        <button id="validationTooltip05" class="btn btn-primary center" style="margin-left: 21%; margin-top: 2%" type="submit" name="SoDefaultButton" value="VseOk">Войти</button>
    </form>
